...
URL = "https://tonyfrnd-77b0094b7659.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tonyfrnd-77b0094b7659.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tonyfrnd-77b0094b7659.herokuapp.com/".format(FQDN)
else:
    URL = "https://tonyfrnd-77b0094b7659.herokuapp.com/".format(FQDN)
