...
URL = "https://krnti-098ea5d05a8e.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://krnti-098ea5d05a8e.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://krnti-098ea5d05a8e.herokuapp.com/".format(FQDN)
else:
    URL = "https://krnti-098ea5d05a8e.herokuapp.com/".format(FQDN)
