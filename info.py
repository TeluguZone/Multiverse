...
URL = "https://daemonx-7420dc73c049.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://daemonx-7420dc73c049.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://daemonx-7420dc73c049.herokuapp.com/".format(FQDN)
else:
    URL = "https://daemonx-7420dc73c049.herokuapp.com/".format(FQDN)
