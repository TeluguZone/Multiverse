...
BOT_TOKEN = environ.get('BOT_TOKEN', "6311976603:AAGubKXu-Xv9FFMdLo7UZVOgYxfRVqSsCAg")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5226707402 809614790').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002034875385') #Channel / Group Id for force sub ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002066898793')) #Log channel id ( make sure bot is admin )
